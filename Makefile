...
install: deps
	...
	@# `make install` installs the editable version of openfisca-germany.
...
build: clean deps
	...
	python -m build
	pip uninstall --yes openfisca-germany
...
test: clean
	openfisca test --country-package openfisca_germany openfisca_germany/tests

serve-local: build
	openfisca serve --country-package openfisca_germany
